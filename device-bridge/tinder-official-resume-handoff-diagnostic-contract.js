...
export const TINDER_OFFICIAL_RESUME_HANDOFF_STAGES = Object.freeze([
  ...
  "V9_DEFERRED_REOBSERVATION_SCHEDULED",
  "V9_DEFERRED_REOBSERVATION_CONSUMED",
  "BLOCKED"
]);
...
export const TINDER_OFFICIAL_RESUME_HANDOFF_REASONS = Object.freeze([
  ...
  "RUNTIME_SAFETY_REJECTED",
  "STRICT_V3_RETURN_UNAVAILABLE",
  "TRANSITIONAL_SURFACE_UNRESOLVED",
  "STRUCTURAL_SAFETY_REJECTED",
  "UNREVIEWED_OFFICIAL_SURFACE",
  "CURRENT_ROOT_SCHEDULE_FAILED",
  "INBOX_PREPARATION_REJECTED",
  "V9_DEFERRED_REOBSERVATION_SCHEDULE_FAILED",
  "V9_DEFERRED_REOBSERVATION_CONSUME_REJECTED",
  "V9_DEFERRED_REOBSERVATION_ARM_REJECTED",
  "LIFECYCLE_RESET"
]);
